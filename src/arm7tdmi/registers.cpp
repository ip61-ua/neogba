...
bool Registers::isSet(u32 mask, u32 dst) const {
  return mask & dst;
}

u32 Registers::read(int reg) const {
...
u32 Registers::read(enum RegistersIndex idx) const {
  return regs[idx];
}
